...
function TitleBar() {
  return (
    <div className=' w-full h-[10vh] px-4 sticky top-0 bg-white flex items-center border-b justify-between'>
      ...
      <div className='flex items-center gap-4'>
        <button className='p-1 border hover:bg-gray-50 rounded-full'>
          <svg
            width={25}
            height={25}
            fill='black'
